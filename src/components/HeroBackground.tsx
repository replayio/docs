export function HeroBackground(props: React.ComponentPropsWithoutRef<'svg'>) {
  ...
  return (
    <svg width="1920" height="1025" viewBox="0 0 1920 1025" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clip-path="url(#clip0_1418_647)">
    <mask id="mask0_1418_647" maskUnits="userSpaceOnUse" x="0" y="0" width="1920" height="1025">
    ...
    <path d="M740.923 573.512L83.6934 934.827" stroke="#F3F3F3"/>
    <path d="M736.072 564.232L64.2883 897.709" stroke="#F3F3F3"/>
    <path d="M731.614 554.758L46.4546 859.81" stroke="#F3F3F3"/>
    <path d="M727.556 545.105L30.2234 821.199" stroke="#F3F3F3"/>
    <path d="M723.906 535.291L15.6238 781.941" stroke="#F3F3F3"/>
    <path d="M720.67 525.332L2.68042 742.106" stroke="#F3F3F3"/>
    <path d="M717.854 515.246L-8.58325 701.764" stroke="#F3F3F3"/>
    <path d="M715.463 505.051L-18.1477 660.985" stroke="#F3F3F3"/>
    <path d="M713.501 494.766L-25.9961 619.842" stroke="#F3F3F3"/>
    <path d="M711.971 484.406L-32.1147 578.406" stroke="#F3F3F3"/>
    <path d="M710.877 473.992L-36.4929 536.751" stroke="#F3F3F3"/>
    <path d="M710.219 463.543L-39.1228 494.95" stroke="#F3F3F3"/>
    <path d="M710 453.074H-40" stroke="#F3F3F3"/>
    <path d="M710.219 442.604L-39.1228 411.197" stroke="#F3F3F3"/>
    <path d="M710.877 432.155L-36.4929 369.396" stroke="#F3F3F3"/>
    <path d="M711.971 421.74L-32.1147 327.74" stroke="#F3F3F3"/>
    <path d="M713.501 411.381L-25.9961 286.305" stroke="#F3F3F3"/>
    <path d="M715.463 401.096L-18.1477 245.162" stroke="#F3F3F3"/>
    <path d="M717.854 390.9L-8.58325 204.383" stroke="#F3F3F3"/>
    <path d="M720.67 380.815L2.68042 164.041" stroke="#F3F3F3"/>
    <path d="M723.906 370.857L15.6238 124.207" stroke="#F3F3F3"/>
    <path d="M727.556 361.043L30.2234 84.9492" stroke="#F3F3F3"/>
    <path d="M731.614 351.39L46.4546 46.3379" stroke="#F3F3F3"/>
    <path d="M736.072 341.914L64.2883 8.4375" stroke="#F3F3F3"/>
    <path d="M740.923 332.636L83.6934 -28.6797" stroke="#F3F3F3"/>
    <path d="M746.159 323.567L104.636 -64.9531" stroke="#F3F3F3"/>
    ...
    <path d="M1173.84 323.567L1815.36 -64.9531" stroke="#F3F3F3"/>
    <path d="M1179.08 332.636L1836.31 -28.6797" stroke="#F3F3F3"/>
    <path d="M1183.93 341.914L1855.71 8.4375" stroke="#F3F3F3"/>
    <path d="M1188.39 351.39L1873.55 46.3379" stroke="#F3F3F3"/>
    <path d="M1192.44 361.043L1889.78 84.9492" stroke="#F3F3F3"/>
