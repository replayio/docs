...
The create response includes a `reverse_proxy_setup_url` you can poll for tunnel status. [Testing a localhost app](/basics/replay-qa/localhost) explains the proxy in detail. For CI builds, see [GitHub Actions](/basics/replay-qa/frpc-ci) or [CircleCI](/basics/replay-qa/circleci).
