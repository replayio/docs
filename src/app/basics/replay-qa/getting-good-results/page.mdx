...
Everything below is configured through the project chat or the project settings. Ask the chat to change a setting and it will do it, or ask for a form when the setting involves credentials.
...
The project **budget** caps how many credits the project spends. The default is a thorough pass; lower it for a smoke test on a small app, raise it for broad coverage on a large one. When the budget is reached the project pauses and the chat tells you.
...
| More budget                                   | Raise the project budget, or wait for the next billing cycle if the account is out of credits |
