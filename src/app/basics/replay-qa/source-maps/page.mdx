...
description: How source maps improve Replay QA's root cause analysis, and how to configure your build to publish them.
---
...
**Actionable root causes.** [Bug reports](/reference/replay-qa/bug-reports) cite the file and line responsible for a failure. Source maps ensure those references point to the right place in your codebase, so a coding agent or developer can go straight to the fix.
