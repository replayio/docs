...
<Callout type="note">
  ...
  the build only exists inside CI, see [Testing a pull request build in GitHub
  Actions](/basics/replay-qa/frpc-ci) or [Testing a pull request build in
  CircleCI](/basics/replay-qa/circleci).
</Callout>
