...
This guide is for testing interactively from your development computer. To test a build that only exists inside a GitHub Actions job, see [Testing a pull request build in GitHub Actions](/basics/replay-qa/frpc-ci) instead.
