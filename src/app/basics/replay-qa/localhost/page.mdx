...
This guide is for testing interactively from your development computer. To test a build that only exists inside CI, see [Testing a pull request build in GitHub Actions](/basics/replay-qa/frpc-ci) or [Testing a pull request build in CircleCI](/basics/replay-qa/circleci).
