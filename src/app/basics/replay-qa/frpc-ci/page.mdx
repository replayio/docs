...
description: Run Replay QA against a pull request build that only exists inside a GitHub Actions job, using the Replay QA CLI to keep the private app reachable.
---
