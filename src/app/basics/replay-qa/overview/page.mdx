...
If the application only exists inside a GitHub Actions runner, the Replay QA CLI can open a tunnel from the runner and keep the app reachable for the complete test run.

[Test a pull request build in GitHub Actions →](/basics/replay-qa/frpc-ci)
