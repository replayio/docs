...
Set the bug to invalid so it is not reported again, and add the intended behavior to the project's design document or instructions so future runs judge against it.
