...
Skills are Markdown instruction files your agent loads on demand. Replay publishes them at [github.com/replayio/skills](https://github.com/replayio/skills/tree/main/skills), and `npx skills add https://github.com/replayio/skills --skill '<name>'` installs one at a time.
...
The same files are served from this site at [`/.well-known/agent-skills/index.json`](/.well-known/agent-skills/index.json) for agents that discover skills automatically.
...
<Callout type="note">
  **React apps:** React analysis tools (render tracking, component inspection,
  performance profiling) work on React 18 and 19, including Next.js 13.5 through
  16, without any source maps or build plugin for React itself. Your
  application's source maps are what give the agent real component and file
  names. See [React support](/basics/replay-qa/source-maps#react-support).
</Callout>
