...
| ------------------------- | ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **app.replay.io API key** | [app.replay.io](https://app.replay.io) team settings | The `replayio` CLI, the `@replayio/playwright` plugin, `replayio upload-source-maps`, CI upload workflows, and the `Authorization` header when connecting to [Replay MCP](/basics/replay-mcp/quickstart) |
