...
Feel free to reach out to [security@replay.io](mailto:security@replay.io) if you would like more information about our security practices or a copy of our SOC 2 Type 1 and Type 2 reports.
