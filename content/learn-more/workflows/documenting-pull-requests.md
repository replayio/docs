...
- For UI changes, use the [Viewer](/reference-guide/viewer)
- For code changes, use [Search](/reference-guide/debugger/search)
- For API changes, use the [Network Monitor](/reference-guide/dev-tools/network)
- To validate changes, use [Print Statements](/reference-guide/debugging/print-statements)

### Comment

Comments in Replay are linked to a point in time and one of the following:

- [A location on the UI](/reference-guide/viewer)
- [A line of code](/reference-guide/debugging/commenting)
- [A network request](/reference-guide/dev-tools/network)
...
![Untitled](/images/Untitled_urgxp.png)
