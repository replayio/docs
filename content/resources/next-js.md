...
If you are using Webpack in your NextJS app you can update your next.config.js [here](/getting-started/teams-admin/uploading-source-maps). If you are using SWC which is now the default, you can update the Vercel build step.
...
Here are the [docs](/getting-started/teams-admin/uploading-source-maps) on the CLI.