...
- Generate API Keys for [recording browser tests](/test-suites)
    - **Note:** Personal API Keys are capped to 10 recordings. For more, [create a team](/getting-started/teams-admin/setting-up-a-team).
...
- Enable [Experimental Features](/resources/get-help/experimental-features)
...
![Screenshot 2023-04-15 at 4.07.55 PM.png](/images/Screenshot_2023-04-15_at_4.07.55_PM_wfsnq.png)