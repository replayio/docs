...
![Screen Shot 2022-01-27 at 10.42.11 AM.png](/images/Screen_Shot_2022-01-27_at_10.42.11_AM_boqgv.png)

### Keyboard Events

Keyboard events include `input`, `keydown`, `keyup`, and `keypress`.

![Screen Shot 2022-01-27 at 10.43.22 AM.png](/images/Screen_Shot_2022-01-27_at_10.43.22_AM_arojy.png)

### XHR Events

XHR events include `load`, `loadstart`, `loadend`, `abort`, `error`, `progress`, `timeout`, and `readystatechange`. 

![Screen Shot 2022-01-27 at 10.44.16 AM.png](/images/Screen_Shot_2022-01-27_at_10.44.16_AM_rcihi.png)
