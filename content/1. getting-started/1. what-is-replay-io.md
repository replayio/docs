...
## Common use cases
- :UIcon{name="i-heroicons-cursor-arrow-rays-20-solid" class="mx-1.5 text-pink-500"} **Local debugging**: developers use Replay to better understand how their application works and debug difficult bugs.
- :UIcon{name="i-heroicons-bug-ant-16-solid" class="mx-1.5 text-pink-500"} **Bug reports**: teams use Replay to record bug reports in their Support and QA workflows so that developers can debug the issues without having to reproduce it locally.
- :UIcon{name="i-ic-baseline-checklist" class="mx-1.5 text-pink-500"} **Flaky and failed tests**: teams use Replay to record their end-to-end tests in CI so that developers can debug flaky and failed tests.
