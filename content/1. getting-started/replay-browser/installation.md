---
title: Installing the Replay browser
description: ''
---
...
## CLI (Replay Chrome) :UBadge{label="New" variant="subtle"}
...
```sh copy
replay launch http://localhost:300
```
...
## Windows :UBadge{label="BETA" variant="outline" size="xs" class="opacity-5"}
