---
title: Uploading recordings with GitHub Actions
---
# Uploading recordings with GitHub Actions

The GitHub action `replayio/action-upload` makes it easy to upload recordings, but if you’d like more control you can also use the `@replayio/replay` CLI to upload replays. [See instructions here]/Test-Runners/Cypress/Cypress-Instructions-(archived)/Recording-with-Other-CI-Providers.md).
