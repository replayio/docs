...
# Integrate Replay with Cypress on GitHub

Cypress provides its own GitHub Action which makes installation and caching much easier. The setup with [cypress-io/github-action](https://github.com/cypress-io/github-action) is very straightforward, but some teams prefer their own custom setup. 
