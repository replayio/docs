...
| :----- | :----- | :----- |
| [GitHub Actions](https://github.com/features/actions) | [GitHub Actions](/test-suites/cypress/continuous-integration/github) |   [workflow.yml](/resources/github.yml) |
| [CircleCI](https://circleci.com/) | CircleCI  |  [circle.yml](/resources/circle.yml) |
