...
Read the full guide on network panel in [reference guide](/reference-guide/devtools/network).
...
Read the full guide on console in [reference guide](/reference-guide/devtools/console).
...
- [Console](/reference-guide/devtools/console)
- [Network panel](/reference-guide/devtools/network)
