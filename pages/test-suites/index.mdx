...
<Callout type="info">
Ready to integrate Replay to Cypress? [Learn how to setup here.](/test-suites/test-runners/cypress)
</Callout>
...
<Callout type="info">
Learn how to [integrate Cypress into Playwright here](/test-suites/test-runners/cypress)
</Callout>
...
Read these guides to see how to set up your pipeline in [CircleCI](/test-suites/ci-environments/circle-ci), [GitHub Actions](/test-suites/ci-environments/circle-ci) and [other providers](/test-suites/ci-environments/circle-ci).
