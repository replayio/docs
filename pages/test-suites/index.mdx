...
import { items } from './test-suites-features'
...
<Callout type="info">
Ready to integrate Replay to Cypress? [Learn how to setup here.](/test-suites/cypress/getting-started)
</Callout>
...
<Callout type="info">
Learn how to [integrate Cypress into Playwright here](/test-suites/cypress/getting-started)
</Callout>
...
<Cards>
  ...
  <Card icon={<VscodeIconsFileTypeCypress />} title="Cypress" href="/test-suites/cypress/getting-started" />
