...
<Callout type="info">
Ready to integrate Replay to Cypress? [Learn how to setup here.](/test-suites/cypress/cypress-installation)
</Callout>
...
<Callout type="info">
Learn how to [integrate Cypress into Playwright here](/test-suites/cypress/cypress-installation)
</Callout>

### Other testing tools
Are you using other tools? We got you covered. You can use Replay Browser to record with [Puppeteer](/test-suites/puppeteer), [WebdriverIO](/test-suites/webdriver-io) and [Jest (alpha)](/test-suites/jest). Your recorings will be available in the same way, so you can examine your code and search for flakes with these frameworks as well. 
...
<Cards>
  ...
  <Card icon={<VscodeIconsFileTypeCypress />} title="Cypress" href="/test-suites/cypress/cypress-installation" />
