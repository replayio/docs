...
In this example, path is defined as a `REPLAY_BROWSER_PATH{:sh}` environment variable. The implementation is up to you, but it is a good practice to move your configuration to a global scope.
