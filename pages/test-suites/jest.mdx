...
1. Install `replay-node`, [as described here](/reference-guide/recording/replay-node).
...
For more details on Replay Node, check out the [Recording Node.js Guide](/reference-guide/recording/replay-node).