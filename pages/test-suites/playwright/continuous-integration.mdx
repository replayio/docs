...
| :----- | :----- | :----- |
| [GitHub Actions](https://github.com/features/actions) | [GitHub Actions](/test-suites/playwright/continuous-integration/github) |   [workflow.yml](/resources/playwright/github.yml) |
