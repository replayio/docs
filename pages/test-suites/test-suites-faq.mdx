...
However, you can use a different CI provider by configuring your run command manually and using `@replayio/replay` to upload recordings. See [Manual CI configuration](https://www.notion.so/Recording-Tests-9f771761436440e6b672701e6107d2b1?pvs=21) for more.
