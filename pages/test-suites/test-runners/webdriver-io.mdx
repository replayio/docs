...
Note: you need to provide API key, either in your shell environment, or by passing it into the command. [You can read more about Replay CLI here](/referrence-guide/recording/replay-cli).