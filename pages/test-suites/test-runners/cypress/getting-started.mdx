...
⚠️ If you run into any problems, consult our troubleshooting guide [here](https://www.notion.so/Cypress-Troubleshooting-Guide-594a024ec8e04445b3c7e83e5436a915?pvs=21).
</Callout>
...
2. Once you’ve created a team, [create a new API Key](https://www.notion.so/Team-Settings-a2f6890352d540e0b114910a9e4c9ff7?pvs=21).
