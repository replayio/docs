...
1. Install `replay-node`, [as described here](https://docs.replay.io/reference-guide/replay-node-(experimental)).
...
For more details on Replay Node, check out the [Recording Node.js Guide](../../Reference-Guide/Recording/Replay-Node-(Experimental).md).