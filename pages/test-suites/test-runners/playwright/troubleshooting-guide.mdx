...
1. Disable caching
2. Have an explicit step for [installing the replay browser](/test-suites/test-runners/playwright/recording-with-git-hub-actions) (**`npx @replayio/playwright install`)**