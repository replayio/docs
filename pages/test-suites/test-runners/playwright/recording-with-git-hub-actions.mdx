...
**Use of GitHub Actions is not required to enable [Pull Request Comments](/test-suites/features/pull-request-comments) in GitHub.**
</Callout>
...
You can also use the `@replayio/replay` CLI to upload replays. [See instructions here](/test-suites/test-runners/cypress/ci-environments/using-other-ci-providers).
