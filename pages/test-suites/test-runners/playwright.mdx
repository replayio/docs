...
When you’re ready to record, you can create an [API Key from the Team Settings](/getting-started/teams-admin/team-settings). Using the API Key connects your recordings to the correct team to ensure access to your replays is protected and your Test Suite Dashboard views are accurate.
...
const config: PlaywrightTestConfig = {
  ...
  use: {
    baseURL: !inCI ? "https://localhost:3000" : undefined,
    launchOptions: {
      slowMo: inCI ? 0 : 500,
    },
  },
