...
[Recording with GitHub Actions](Playwright/Recording-with-GitHub-Actions.md)

## Other CI Providers

[Recording with Other CI Providers](Playwright/Recording-with-Other-CI-Providers.md)
...
- Configure Playwright to only use a single worker and increase the timeout if needed to allow for increased run time. ([See config example below](Playwright.md)).
...
[Troubleshooting Guide](Playwright/Troubleshooting-Guide.md)

[Playwright FAQs](Playwright/Playwright-FAQs.md)

[Playwright Node](Playwright/Playwright-Node.md)