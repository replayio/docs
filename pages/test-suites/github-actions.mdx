...
The GitHub action `replayio/action-upload` makes it easy to upload recordings, but if you’d like more control you can also use the `@replayio/replay` CLI to upload replays. [See instructions here](/test-suites/test-runners/cypress/ci-environments/using-other-ci-providers).
