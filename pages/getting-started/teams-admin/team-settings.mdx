...
- Update billing information ([Admin role only](/getting-started/teams-admin/team-settings))
...
Teams can create API Keys for uploading [source maps](/getting-started/teams-admin/uploading-source-maps) during deploys or uploading replays of [automated tests](/test-suites). The number of recordings allowed is based on your plan.
