...
Teams can create API Keys for uploading [source maps](/pages/getting-started/teams-admin/uploading-source-maps) during deploys or uploading replays of [automated tests](/test-suites). The number of recordings allowed is based on your plan.
