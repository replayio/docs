...
A payment method can be added from the Billing section in [Team Settings](/getting-started/teams-admin/team-settings). To update a payment method, delete the current card and you will be able to add a new one.

![Screen Shot 2022-05-18 at 9.42.58 AM.png](/images/Screen_Shot_2022-05-18_at_9.42.58_AM_lthvc.png)
...
![Screenshot 2022-12-30 at 1.06.14 PM.png](/images/Screenshot_2022-12-30_at_1.06.14_PM_bdlzw.png)
...
Any User can record, view, and comment on replays. Developers also have access to print statements and console evaluations. You would only pay for the number of Developer seats needed. See [User Role Definitions](/getting-started/teams-admin/team-settings) for details.
