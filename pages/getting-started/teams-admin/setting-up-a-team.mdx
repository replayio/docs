...
Teams can create API Keys for uploading [source maps](/getting-started/teams-admin/uploading-source-maps) during deploys or uploading replays recorded programmatically via our [Node](/reference-guide/recording/replay-node-(experimental)), [Playwright](/test-suites/playwright/installation), or **[Puppeteer](/test-suites/puppeteer)** recorders.
