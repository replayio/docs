...
<Callout type="warning" emoji="💡">
We launched our Firefox Windows browser as an experiment in 2021. We've since migrated to Chrome and hope to release a proper Chrome for Windows browser in the not too distant future.
</Callout>
