...
# Welcome to Replay
**Replay is a tool that allows you to record your application and then debug everything that happened during runtime.** Think of the nastiest bug you have ever faced. You would be able to fix it in minutes with insights that Replay provides. Experience with replay consists of two main parts:
