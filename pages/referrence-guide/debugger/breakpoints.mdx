...
![Adding a breakpoint](/media/referrence-guide/debugger/breakpoints/adding-breakpoint.png)
...
![Navigating between breakpoints](/media/referrence-guide/debugger/breakpoints/navigating-between-breakpoints.png)

### Stepping forward and backwards

Click step forward or backwards to go to the next or previous expression.

![Stepping forward and backwards](/media/referrence-guide/debugger/breakpoints/stepping-forwards-backwards.png)

### Stepping in

Click step in to enter the next function call or advance to the next expression.

![Stepping in](/media/referrence-guide/debugger/breakpoints/stepping-in.png)

### Stepping out

Click step out to exit the current function.

![Stepping out](/media/referrence-guide/debugger/breakpoints/stepping-out.png)
...
![untitled](/media/referrence-guide/debugger/breakpoints/scrubbing-forward-and-backwards.png)
...
<Video src="/media/referrence-guide/debugger/breakpoints/navigationshortcuts.mp4" width='100%'/>
...
![Call stack](/media/referrence-guide/debugger/breakpoints/call-stack.png)
...
![Scopes](/media/referrence-guide/debugger/breakpoints/scopes.png)