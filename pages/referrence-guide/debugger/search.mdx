...
<Video src="/media/referrence-guide/debugger/search/search-source-text.mp4" width='100%'/>
...
<Video src="/media/referrence-guide/debugger/search/search-node-modules.mov" width='100%'/>
