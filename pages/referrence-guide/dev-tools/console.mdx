...
![Fast forward to a message](/media/referrence-guide/dev-tools/console/fast-forward.png)
...
![Evaluating expressions](/media/referrence-guide/dev-tools/console/evaluating-expressions.png)
...
<Video src="/media/referrence-guide/dev-tools/console/clear-console.mov"/>
...
[Inspecting object](/media/referrence-guide/dev-tools/console/inspecting-objects.mp4)
...
<Video src="/media/referrence-guide/dev-tools/console/viewing-stack-traces.mp4" />
...
![Untitled](/media/referrence-guide/dev-tools/console/Untitled-2.png)
...
![Untitled](/media/referrence-guide/dev-tools/console/Untitled-3.png)
...
![Screen Shot 2022-03-11 at 10.26.40 AM.png](/media/referrence-guide/dev-tools/console/Screen_Shot_2022-03-11_at_10.26.40_AM.png)

- The getters and setters will populate with autocomplete when inputing an object in the console.

![Screen Shot 2022-03-11 at 11.19.04 AM.png](/media/referrence-guide/dev-tools/console/Screen_Shot_2022-03-11_at_11.19.04_AM.png)

- When viewing an object in a source, the object details will list the getters.

![Screen Shot 2022-03-11 at 10.27.15 AM.png](/media/referrence-guide/dev-tools/console/Screen_Shot_2022-03-11_at_10.27.15_AM.png)

### Viewing Timestamps

It’s possible to view the timestamp for each console log by selecting Timestamps in the bottom of the drawer

![Untitled](/media/referrence-guide/dev-tools/console/Untitled-4.png)