...
- [Elements](/referrence-guide/dev-tools/elements) Inspect ui element styles and attributes
- [Console](/referrence-guide/dev-tools/console) Inspect logs, exceptions, errors, and events 
- [Network](/referrence-guide/dev-tools/network) Inspect network activity, requests, and response bodies
- [React](/referrence-guide/dev-tools/react) Inspect react components, their state and props 
- [Search](/referrence-guide/debugger/Search) Search files, functions, and text
- [Pause](/referrence-guide/debugger/Breakpoints) Inspect the call stack and scope

<Callout type="info" emoji="💡">
Want to know how to best use these features for debugging? Check out [Debugging](/Getting-Started/Debugging-Overview.md).
</Callout>

![Untitled](/media/referrence-guide/dev-tools/Untitled.png)

<Callout type="info" emoji="👉">
You can also view [Events](/referrence-guide/viewer/events) from the Replay Info panel in DevTools or Viewer mode.
</Callout>
...
![Untitled](/media/referrence-guide/dev-tools/Untitled-1.png)
...
![Untitled](/media/referrence-guide/dev-tools/Untitled-2.png)

Examples:

- Open the Network Monitor
- Show comments in the sidebar
- Launch the [Sources Search](/referrence-guide/debugger/search) modal
