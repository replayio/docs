...
The **Replay Library** is your home for accessing replays, updating settings including Billing, and launching the [Replay Browser](Recording/Replay-Browser.md). 
...
![Screen Shot 2022-01-25 at 11.29.02 AM.png](/media/referrence-guide/library/Screen_Shot_2022-01-25_at_11.29.02_AM.png)
...
View your user profile settings by clicking “View settings” under your name at the bottom of the left sidebar. See [User Settings](../Resources/Get-Help/User-Settings.md) for more details.

## Updating team settings

Access team settings by clicking the gear icon next to the team name in the sidebar. You can also create a new team from the sidebar.  See [Team Settings](../Teams-&-Admin/Team-Settings.md) for more details.

![Screen Shot 2022-01-25 at 11.33.29 AM.png](/media/referrence-guide/library/Screen_Shot_2022-01-25_at_11.33.29_AM.png)