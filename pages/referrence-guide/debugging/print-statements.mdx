...
![Adding a print statement](/media/referrence-guide/debugging/print-statements/adding-print-statement.png)
...
![Print statement output](/media/referrence-guide/debugging/print-statements/print-statement-output.png)
...
![Editing print statement](/media/referrence-guide/debugging/print-statements/editing-print-statement.png)
...
![Adding a comment from print statement](/media/referrence-guide/debugging/print-statements/adding-comment-from-print-statement.png)
...
![Navigating to console log](/media/referrence-guide/debugging/print-statements/navigating-to-console-log.png)
...
![Adding a comment to console log](/media/referrence-guide/debugging/print-statements/adding-comment-to-console-log.png)
...
![Adding print statement condition](/media/referrence-guide/debugging/print-statements/adding-print-statement-condition.png)
...
![Print statement prefix](/media/referrence-guide/debugging/print-statements/print-statement-prefix.png)