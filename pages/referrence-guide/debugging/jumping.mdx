...
<Video src="/media/referrence-guide/debugging/Jumping/jump-to-line.mp4"/>
...
<Video src="/media/referrence-guide/debugging/Jumping/jump-to-cypress-event.mp4"/>

### Jump to console message

Hover on a console message and click on **Jump to code** to seek to where the message was emitted.

<Video src="/media/referrence-guide/debugging/Jumping/jump-to-console-message.mp4"/>

### Jump to request

Hover on a network XHR event and click on **Jump to code** to seek to where the request originated.

<Video src="/media/referrence-guide/debugging/Jumping/jump-to-request.mp4"/>