...
![Focus Mode](/media/referrence-guide/debugging/focus-mode/focus-mode.png)
...
![Set focus from the console](/media/referrence-guide/debugging/focus-mode/set-focus-from-console.png)
...
![Set Focus From Print Statement](/media/referrence-guide/debugging/focus-mode/set-focus-from-print-statement.png)
...
![Hidden logs](/media/referrence-guide/debugging/focus-mode/hidden-logs.png)
