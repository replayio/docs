...
![Screenshot 2023-04-07 at 8.47.24 AM.png](/media/referrence-guide/viewer/events/Screenshot_2023-04-07_at_8.47.24_AM.png)
...
![Untitled](/media/referrence-guide/viewer/events/Untitled.png)
...
![Screen Shot 2022-01-27 at 10.42.11 AM.png](/media/referrence-guide/viewer/events/Screen_Shot_2022-01-27_at_10.42.11_AM.png)

### Keyboard Events

Keyboard events include `input`, `keydown`, `keyup`, and `keypress`.

![Screen Shot 2022-01-27 at 10.43.22 AM.png](/media/referrence-guide/viewer/events/Screen_Shot_2022-01-27_at_10.43.22_AM.png)

### XHR Events

XHR events include `load`, `loadstart`, `loadend`, `abort`, `error`, `progress`, `timeout`, and `readystatechange`. 

![Screen Shot 2022-01-27 at 10.44.16 AM.png](/media/referrence-guide/viewer/events/Screen_Shot_2022-01-27_at_10.44.16_AM.png)
