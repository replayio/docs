...
- **Guide:** [Uploading Source Maps](/replay-documentation/pages/getting-started/teams-admin/uploading-source-maps1)
...
- **[Documentation:** Commenting on the video](/pages/referrence-guide/viewer)
- **[Documentation:** Adding a comment on a source](/referrence-guide/debugger/search)
- **[Documentation:** Adding a comment from a print statement](/referrence-guide/debugging/print-statements)

## Getting Started

To get started, simply [create a team]/getting-started/teams-admin/setting-up-a-team in Replay, then contact us to set up your OSS plan! We’re here to help with any questions and get you up and running. Visit [replay.io/get-started](http://replay.io/get-started) to learn more.