...
You can download the browser by going to [replay.io](https://replay.io) and clicking download. Once you launch the browser, you will be prompted to sign in with your Google account.

**Note:** If you’ve used Replay before, [make sure the browser is up-to-date](/test-suites/playwright/troubleshooting-guide) before recording.

![Screen Shot 2021-11-23 at 2.38.15 PM.png](/images/Screen_Shot_2021-11-23_at_2.38.15_PM_klyky.png)
