...
Once you save the replay, adding [Comments](/referrence-guide/debugging/commenting) is a great way to leave notes for yourself or other members of your team. You can add comments to the video, print statements, console logs, network requests, or a source.
