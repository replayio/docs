...
Check out the [Recording a Replay guide](/pages/getting-started/recording-your-first-replay) for details.
...
- For code changes, use [Search](/referrence-guide/debugger/search.mdx)
- For API changes, use the [Network Monitor](/referrence-guide/dev-tools/network)
- To validate changes, use [Print Statements](/referrence-guide/debugging/print-statements.mdx)
