...
- **Replay Client** [Open Source]
    ...
    - [The Replay CLI](/referrence-guide/recording/replay-cli) ([src](https://github.com/replayio/replay-cli): https://github.com/replayio/replay-cli) allows you to programmatically interact with a Replay.
...
- **Runtime** [Open Source]
    - The most prominent runtime is our “[Replay Browser](/referrence-guide/recording/replay-browser)” based on Firefox ([src](https://github.com/replayio/gecko-dev): https://github.com/replayio/gecko-dev), available in our Downloads section.
