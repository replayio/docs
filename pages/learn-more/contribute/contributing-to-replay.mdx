...
- **Read the Documentation:** Before you start contributing, read the documentation and [Reference Guide](/reference-guide) for the project you’re interested. This will help you understand how the project works and what you need to do to contribute.
