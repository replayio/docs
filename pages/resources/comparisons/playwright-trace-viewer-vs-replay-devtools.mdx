...
Because Replay is simply a browser, you can start recording your tests by adding `Replay Chromium` in your playwright config [here](/test-suites/playwright). And when you open a replay you can start time traveling!
