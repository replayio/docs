...
If you run into an issue while recording with the **[Replay Browser](/referrence-guide/recording/replay-browser)**, these tips can help identify the issue. If you have any questions or get stuck, don’t hesitate to [contact us](/resources/get-help/contact-community.mdx).
...
1. Launch Replay and [open the browser toolbox](/media/resources/get-help/troubleshooting.md). This will open a new window with standard devtools (but connected to the browser instead of the current web page)
...
[Importing SSL Certificate](/media/resources/get-help/troubleshooting/Importing%20SSL%20Certificate%20b7903b2fa1ce49228d000738cb81bcc8.md)
