...
![Adding a breakpoint](/media/reference-guide/debugger/breakpoints/adding-breakpoint.png)
...
![Navigating between breakpoints](/media/reference-guide/debugger/breakpoints/navigating-between-breakpoints.png)

### Stepping forward and backwards

Click step forward or backwards to go to the next or previous expression.

![Stepping forward and backwards](/media/reference-guide/debugger/breakpoints/stepping-forwards-backwards.png)

### Stepping in

Click step in to enter the next function call or advance to the next expression.

![Stepping in](/media/reference-guide/debugger/breakpoints/stepping-in.png)

### Stepping out

Click step out to exit the current function.

![Stepping out](/media/reference-guide/debugger/breakpoints/stepping-out.png)
...
![untitled](/media/reference-guide/debugger/breakpoints/scrubbing-forward-and-backwards.png)
...
<Video src="/media/reference-guide/debugger/breakpoints/navigationshortcuts.mp4"/>
...
![Call stack](/media/reference-guide/debugger/breakpoints/call-stack.png)
...
![Scopes](/media/reference-guide/debugger/breakpoints/scopes.png)