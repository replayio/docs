...
![Search](/media/reference-guide/debugger/search/search.png)
...
<Video src="/media/reference-guide/debugger/search/search-source-text.mp4"/>
...
<Video src="/media/reference-guide/debugger/search/search-node-modules.mov"/>
...
![Search function](/media/reference-guide/debugger/search/search-function.png)