...
![Set focus from the console](/images/set-focus-from-console_nboif.png)
...
![Set Focus From Print Statement](/images/set-focus-from-print-statement_oqizx.png)
...
![Hidden logs](/images/hidden-logs_ulwqd.png)
