...
![Print statement comment](/media/reference-guide/debugging/commenting/print-statement-comment.png)
...
![Console log comment](/media/reference-guide/debugging/commenting/console-log-comment.png)
