...
![Fast forward to a message](/images/fast-forward_svtie.png)
...
![Untitled](/images/Untitled-2_dwyjd.png)

## Viewing event listeners

Replay can show event listeners for mouse, keyboard, worker, and any other standard event in the console. You can toggle which event listeners are output in the console in the same console settings pane. Check out [Events](/reference-guide/viewer/events) for more details on event types.
...
![Untitled](/images/Untitled-3_ciomw.png)
...
![Screen Shot 2022-03-11 at 10.26.40 AM.png](/images/Screen_Shot_2022-03-11_at_10.26.40_AM_nbgfw.png)

- The getters and setters will populate with autocomplete when inputing an object in the console.

![Screen Shot 2022-03-11 at 11.19.04 AM.png](/images/Screen_Shot_2022-03-11_at_11.19.04_AM_khbay.png)

- When viewing an object in a source, the object details will list the getters.

![Screen Shot 2022-03-11 at 10.27.15 AM.png](/images/Screen_Shot_2022-03-11_at_10.27.15_AM_cgejo.png)

### Viewing Timestamps

It’s possible to view the timestamp for each console log by selecting Timestamps in the bottom of the drawer

![Untitled](/images/Untitled-4_pcyer.png)