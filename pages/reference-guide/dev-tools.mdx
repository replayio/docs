...
- [Elements](/reference-guide/dev-tools/elements) Inspect ui element styles and attributes
- [Console](/reference-guide/dev-tools/console) Inspect logs, exceptions, errors, and events 
- [Network](/reference-guide/dev-tools/network) Inspect network activity, requests, and response bodies
- [React](/reference-guide/dev-tools/react) Inspect react components, their state and props 
